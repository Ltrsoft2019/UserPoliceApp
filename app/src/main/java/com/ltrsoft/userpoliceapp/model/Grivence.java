...
public class Grivence {
    ...
    public String getNature_of_grievance() {
        return nature_of_grievance;
    }

    public void setNature_of_grievance(String nature_of_grievance) {
    ...
    public void setAudio_video(String audio_video) {
