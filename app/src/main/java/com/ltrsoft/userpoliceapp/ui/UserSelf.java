...
public class UserSelf {
    ...
    public UserSelf(Context context, LinearLayout layout) {
        ...
        dao.select(Users.class, "user_id", "1", new NewCallBack() {
            ...
            public void onError(String error) {
                Toast.makeText(context, "erroro while laoding data "+error, Toast.LENGTH_SHORT).show();
            }
            ...
            Users users = list.get(0);
                USERFNAME = users.getUser_fname();
                USERMNAME = users.getUser_mname();
                USERLNAME = users.getUser_lname();
                USERADDRESS = users.getUser_address();
            }
    ...
    public void generateUserSelf(Fragment fragment, Button submit, Fragment fragment2){
        elements=new ArrayList<>();
        elements.add(new FormElement(USERFNAME, FormElement.TYPE_EDIT_TEXT,FormElement.SYBTYPE_SEXT_TEXT, R.drawable.cam2));
        elements.add(new FormElement(USERMNAME, FormElement.TYPE_EDIT_TEXT,FormElement.SYBTYPE_SEXT_TEXT,R.drawable.cam2));
        elements.add(new FormElement(USERLNAME, FormElement.TYPE_EDIT_TEXT,FormElement.SYBTYPE_SEXT_TEXT,R.drawable.cam2));
        elements.add(new FormElement(USERDATEOFBIRTH, FormElement.TYPE_BUTTON,FormElement.SYBTYPE_SEXT_TEXT,R.drawable.cam2));
        elements.add(new FormElement(USERADDRESS, FormElement.TYPE_EDIT_TEXT,FormElement.SYBTYPE_SEXT_TEXT,R.drawable.cam2));
        elements.add(new FormElement(USEREMAIL, FormElement.TYPE_EDIT_TEXT,FormElement.SYBTYPE_SEXT_TEXT,R.drawable.cam2));
//        elements.add(new FormElement(USERPASSWORD, FormElement.TYPE_EDIT_TEXT,FormElement.SUBTYPE_EMAIL,R.drawable.cam2));
        elements.add(new FormElement(USERGENDER, FormElement.TYPE_RADIO_GROUP,FormElement.SYBTYPE_SEXT_TEXT,R.drawable.cam2));
        elements.add(new FormElement(USERMOBILE1, FormElement.TYPE_EDIT_TEXT,FormElement.SYBTYPE_SEXT_TEXT,R.drawable.cam2));
        elements.add(new FormElement(USERMOBILE2, FormElement.TYPE_EDIT_TEXT,FormElement.SYBTYPE_SEXT_TEXT,R.drawable.cam2));
        elements.add(new FormElement(USERADHAR, FormElement.TYPE_EDIT_TEXT,FormElement.SYBTYPE_SEXT_TEXT,R.drawable.cam2));
        elements.add(new FormElement(USERPAN, FormElement.TYPE_EDIT_TEXT,FormElement.SYBTYPE_SEXT_TEXT,R.drawable.cam2));
        elements.add(new FormElement(USEROCCUPATION, FormElement.TYPE_EDIT_TEXT,FormElement.SYBTYPE_SEXT_TEXT,R.drawable.cam2));
        elements.add(new FormElement(USERNATIONALITY, FormElement.TYPE_EDIT_TEXT,FormElement.SYBTYPE_SEXT_TEXT,R.drawable.cam2));
        elements.add(new FormElement(USERDRIVING, FormElement.TYPE_EDIT_TEXT,FormElement.SYBTYPE_SEXT_TEXT,R.drawable.cam2));
